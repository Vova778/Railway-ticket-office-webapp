...
public class CreateTrainCommand implements Command {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            LOGGER.info("{} Train from view : {};", ADD_TRAIN_COMMAND,train);

            trainService.insert(train);
            LOGGER.info("{} Train was successfully saved : {}", ADD_TRAIN_COMMAND, train);
        } catch (ServiceException e) {
            LOGGER.error("An exception occurs while saving train");
